...
<p align="center"><strong>Un motor de navegador en Rust puro derivado de servo.</strong></p>
...
SySL-1.0 (Synthetic Source License). Ver [LICENSE](../../LICENSE) o el [sitio de SySL](https://sysl.celestia.world).
